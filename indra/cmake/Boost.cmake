...
if (STANDALONE)
  ...
  if (WINDOWS)
    ...
    elseif (MSVC90)
  	...
  	find_library(PROGRAM_LIB NAMES boost_program_options PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(REGEX_LIB NAMES boost_regex PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(PYTHON_LIB NAMES boost_python PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(SIGNALS_LIB NAMES boost_signals PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(WAVE_LIB NAMES boost_wave PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(SYSTEM_LIB NAMES boost_system PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(FILESYSTEM_LIB NAMES boost_filesystem PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(IOSTREAMS_LIB NAMES boost_iostreams PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(DATE_LIB NAMES boost_date_time PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(THREAD_LIB NAMES boost_thread PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
