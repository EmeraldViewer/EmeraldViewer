...
if (STANDALONE)
  ...
  if (WINDOWS)
    ...
    elseif (MSVC90)
  	...
  	find_library(PROGRAM_LIB NAMES boost_program_options-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(REGEX_LIB NAMES boost_regex-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(PYTHON_LIB NAMES boost_python-mt-py26 boost_python-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(SIGNALS_LIB NAMES boost_signals-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(WAVE_LIB NAMES boost_wave-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(SYSTEM_LIB NAMES boost_system-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(FILESYSTEM_LIB NAMES boost_filesystem-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(IOSTREAMS_LIB NAMES boost_iostreams-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(DATE_LIB NAMES boost_date_time-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
  	find_library(THREAD_LIB NAMES boost_thread-mt PATHS ${ARCH_PREBUILT_DIRS_RELEASE} NO_DEFAULT_PATH)
